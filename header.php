    ...
    <header>
      <nav class="nav-header-main">
        <a class="header-logo" href="index.php">
          <img src="./assets/images/zombie.png" alt="logo">
        </a>
        <ul>
      ...
      <div class="header-login">
        ...
        The "inputs" I decided to have in the form include username/email and password. The user will be able to choose whether to login using email or username.
